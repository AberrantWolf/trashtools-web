...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: 'phono-junk',
    emoji: '💿',
    tagline: 'rip, identify, verify & catalog audio CDs',
    blurb:
    ...
    platform: 'CLI',
    status: 'WIP',
    tags: ['audio CDs', 'MusicBrainz', 'AccurateRip', 'FLAC'],
    accent: 'teal',
  },
  {
    slug: 'art-junk',
    name: 'art-junk',
    emoji: '🎨',
    tagline: 'a fast, stylus-first vector drawing app',
    blurb:
    ...
    platform: 'Desktop',
    status: 'WIP',
    tags: ['drawing', 'GPU', 'stylus', 'vector'],
    accent: 'hazard',
  },
  {
    slug: 'block-junk',
    name: 'block-junk',
    emoji: '🧱',
    tagline: 'a voxel world where you tell the guys to build',
    blurb:
    ...
    platform: 'Desktop',
    status: 'WIP',
    tags: ['voxel', 'game', 'simulation', 'mods'],
    accent: 'rust',
  },
  {
    slug: 'junk-libs',
